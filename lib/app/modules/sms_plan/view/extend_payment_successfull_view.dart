...
class extend_sms_payment_success_view extends StatelessWidget {
  const extend_sms_payment_success_view({super.key});
            ...
            children: [
              ...
              Container(
                ...
                child: Text.rich(
                  ...
                  TextSpan(
                    text:
                        'You have successfully extended your Daily Package (50 SMS) and this cost you ',
                    children: [
                      TextSpan(
                        text: 'XAF 6,000',
                        style: TextStyle(
              ...
              Container(
                ...
                child: Text.rich(
                  textAlign: TextAlign.center,
                  TextSpan(
                    text: 'You have 50 SMS left in your plan  ',
                  ),
                ),
              ),
