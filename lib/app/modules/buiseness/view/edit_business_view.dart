...
class EditBusinessViewState extends State<EditBusinessView> {
  ...
  void initState() {
    ...
    add_controller.website_address_controller.text =
        widget.data['website'] ?? '';
    ...
    add_controller.phone_controller.text =
        widget.data['phone'].toString().contains("237")
            ? widget.data['phone'].toString().substring(4).trim()
            : widget.data['phone'].toString();
    add_controller.email_controller.text = widget.data['email'] ?? '';
    add_controller.description_controller.text =
        widget.data['description'] ?? '';
    add_controller.whatsapp_controller.text =
        widget.data['whatsapp'].toString();
    ...
    setState(() {
      ...
      regionCode = widget.data['region'] != null
          ? widget.data['region']['id'] as int
          : null;
      town =
          widget.data['town'] != null ? widget.data['town']['id'] as int : null;
              ...
              SingleChildScrollView(
                child: Wrap(
                  children: [
                    ...
                    Obx(
                      () => SizedBox(
                        height: imageController.image_path.isEmpty ||
                                imageController.image_path.contains("default")
                            ? null
                            : Get.height * 0.40,
                    ...
                    //                 ),
                    //                 keyboardType: TextInputType.number,
                    //                 initialCountryCode: wcountry.code,
                    //                 showDropdownIcon: false,
                    //                 dropdownTextStyle: const TextStyle(
                    //                   color: Colors.black,
                    //                   fontSize: 17,
