...
class EditProductViewState extends State<EditProductView> {
  ...
  void initState() {
    ...
    product_controller.loadShops().then((_) {
      product_controller.product_name_controller.text =
          widget.data!['name'] ?? '';
      product_controller.shop_Id_controller.text =
          widget.data!['shop']['id'].toString();
      product_controller.unit_price_controller.text =
          widget.data!['unit_price'].toString();
      product_controller.product_desc_controller.text =
          widget.data!['description'] ?? '';
      product_controller.product_tags_controller.text =
          widget.data!['tags'] ?? '';
      product_controller.category_controller.text =
          widget.data!['category']['name'];
      product_controller.quantity_controller.text =
          widget.data!['quantity'].toString() == 'null'
              ? ''
      ...
      Shop? shop = product_controller.shopList
          .firstWhereOrNull((s) => s.id == widget.data!['shop']['id'] as int);
    ...
    if (name == '') {
      ...
      try {
        ...
        if (imageController.image_path.toString() == '') {
          ProductAPI.updateProductOrService(
                  value, context, widget.data?['slug'])
              .then((response_) {
          ...
          ProductAPI.updateProductOrServiceWithImage(value, context,
                                                    ...
                                                    imageController2
                                                        .addImageFromGallery(
                                                            widget
                                                                .data?['slug']);
                                                    print(
                                                        'image list: ${imageController2.imageList}');
                                                  },
                                                  color: appcolor().greyColor,
                                                ),
                                                SizedBox(
                              ...
                              child: Center(
                                child: ListView.builder(
                                  ...
                                  itemBuilder: (context, index) {
                                    ...
                                    if (index <
                                        imageController2
                                            .uploadStatusList.length) {
                                      uploadStatus = imageController2
                                          .uploadStatusList[index];
                                    }
                                ...
                                InkWell(
                                  onTap: () async {
                                    await imageController
                                        ...
                                        .then((_) {
                                      print(
                                          "image list: ${imageController.imageList}");
                                ...
                                InkWell(
                                  onTap: () {
                                    ...
                                    showDialog(
                                          ...
                                          return CustomAlertDialog(
                                            ...
                                            onConfirm: () async {
                                              ...
                                              imageController
                                                  ...
                                                  .then((response) {
                                                print(
                                                    "***deleted all images response ****: $response");
                                              });
                                            },
                                            onCancel: () {
                                              Get.back();
                                      ...
                                      print(
                                          "**** 8888 **8 deleted all images *****888***88888");
                                    });
                                  ...
                                  child: Container(
                                    ...
                                    decoration: BoxDecoration(
                                        color: Colors
                                            .white, // Consider a different color for delete action
                                        borderRadius: BorderRadius.circular(10),
                                        border: Border.all(
